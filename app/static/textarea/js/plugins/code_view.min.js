  ...
  (e = e && e.hasOwnProperty("default") ? e["default"] : e),
    ...
    (e.PLUGINS.codeView = function (c) {
        ...
        p() &&
          ...
          c.opts.heightMin || c.opts.height
            ? (c.$box
                ...
                .css("min-height", c.opts.heightMin || c.opts.height),
      ...
      function o(e) {
        d ||
          (!(function l() {
            (d = h('<textarea class="fr-code" tabIndex="-1">')),
              c.$wp.append(d),
              d.attr("dir", c.opts.direction),
              c.$box.hasClass("fr-basic") ||
                ((m = h(
                  '<a data-cmd="html" title="Code View" class="fr-command fr-btn html-switch'.concat(
                    c.helpers.isMobile() ? "" : " fr-desktop",
                    '" role="button" tabIndex="-1"><i class="fa fa-code"></i></button>'
                  )
                )),
                c.$box.append(m),
                c.events.bindClick(c.$box, "a.html-switch", function () {
                  c.events.trigger("commands.before", ["html"]),
                    M(!1),
                    c.events.trigger("commands.after", ["html"]);
                }));
            var e = function e() {
              return !p();
            };
            c.events.on("buttons.refresh", e),
              ...
              c.events.on(
                ...
                function () {
                  p() &&
                    (c.html.set(u()),
                    c.events.trigger("contentChanged", [], !0));
                },
                !0
              );
          })(),
          !f && c.opts.codeMirror
            ...
            : (c.events.$on(d, "keydown keyup change input", function () {
              ...
              c.events.$on(d, "blur", v),
              c.events.$on(d, "focus", w))),
          c.undo.saveStep(),
        ...
        if (
          (c.core.hasFocus() &&
            ((n = !0), c.events.disableBlur(), c.$el.blur()),
          (t = (t = t.replace(
            /<span class="fr-tmp fr-sm">F<\/span>/,
            "FROALA-SM"
          )).replace(/<span class="fr-tmp fr-em">F<\/span>/, "FROALA-EM")),
          c.codeBeautifier &&
            !t.includes("fr-embedly") &&
            (t = c.codeBeautifier.run(t, c.opts.codeBeautifierOptions)),
          f)
        ) {
          (r = t.indexOf("FROALA-SM")),
            (o = t.indexOf("FROALA-EM")) < r ? (r = o) : (o -= 9);
          var s =
              (t = t
                .replace(/FROALA-SM/g, "")
                .replace(/FROALA-EM/g, "")).substring(0, r).length -
          ...
          (r =
            ...
            t.substring(0, t.substring(0, r).lastIndexOf("\n") + 1).length),
            (o =
              t.substring(0, o).length -
              t.substring(0, t.substring(0, o).lastIndexOf("\n") + 1).length),
            ...
            f.focus(),
            (b = !0),
            f.setSelection({ line: s, ch: r }, { line: i, ch: o }),
            f.refresh(),
            f.clearHistory();
        } else {
          (r = t.indexOf("FROALA-SM")),
            (o = t.indexOf("FROALA-EM") - 9),
            c.opts.heightMin && d.css("min-height", c.opts.heightMin),
            c.opts.height && d.css("height", c.opts.height),
            c.opts.heightMax &&
              d.css("max-height", c.opts.height || c.opts.heightMax),
            d
              .val(t.replace(/FROALA-SM/g, "").replace(/FROALA-EM/g, ""))
              .trigger("change");
          var a = h(c.o_doc).scrollTop();
          (b = !n),
            d.focus(),
            (b = !0),
            d.get(0).setSelectionRange(r, o),
            h(c.o_doc).scrollTop(a);
        }
        c.$tb
          .find(
          ...
          .filter(function () {
            return (
              c.opts.codeViewKeepActiveButtons.indexOf(h(this).data("cmd")) < 0
            );
          })
