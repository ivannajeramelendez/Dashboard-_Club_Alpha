...
!(function (o, t) {
  ...
  (k = k && k.hasOwnProperty("default") ? k["default"] : k),
    Object.assign(k.POPUP_TEMPLATES, {
    ...
    (k.PLUGINS.colors = function (g) {
      var E = g.$,
        l =
          '<div class="fr-color-hex-layer fr-active fr-layer" id="fr-color-hex-layer- \n  '
            ...
            .concat(
              g.language.translate("HEX Color"),
              '" \n  tabIndex="1" aria-required="true"></div><div class="fr-action-buttons"><button \n  type="button" class="fr-command fr-submit" data-cmd="[COMMAND]" tabIndex="2" role="button">\n  '
            )
            .concat(g.language.translate("OK"), "</button></div></div>");
      function s(o) {
        for (
          var t = "text" === o ? g.opts.colorsText : g.opts.colorsBackground,
            r = '<div class="fr-color-set fr-'.concat(
              o,
          ...
          0 !== e && e % g.opts.colorsStep == 0 && (r += "<br>"),
            "REMOVE" !== t[e]
              ? (r +=
                  '<span class="fr-command fr-select-color" style="background:'
                    ...
                    .concat(o, 'Color" \n        data-param1="')
                    .concat(t[e], '"><span class="fr-sr-only"> ')
                    .concat(g.language.translate("Color"))
                    .concat(
                      t[e],
                      " \n        &nbsp;&nbsp;&nbsp;</span></span>"
                    ))
              : (r += '<span class="fr-command fr-select-color" data-cmd="apply'
                  .concat(
                    o,
                    'Color"\n         tabIndex="-1" role="button" data-param1="REMOVE" \n         title="'
                  )
                  .concat(g.language.translate("Clear Formatting"), '">')
                  .concat(
                    g.icon.create("remove"),
                    ' \n        <span class="fr-sr-only"> '
                  )
                  .concat(
                    g.language.translate("Clear Formatting"),
                    " </span></span>"
                  ));
        return "".concat(r, "</div>");
      }
      function i(o) {
        ...
        for (
          c.find(".fr-selected-color").remove(),
            c.removeClass("fr-active-item"),
            c.not('[data-param1="REMOVE"]').attr("aria-selected", !1);
          e.get(0) !== g.el;
          ...
          if ("transparent" !== e.css(t) && "rgba(0, 0, 0, 0)" !== e.css(t)) {
            var a = r.find(
              ".fr-"
                .concat(o, '-color .fr-select-color[data-param1="')
                .concat(g.helpers.RGBToHex(e.css(t)), '"]')
            );
            a.append(
        ...
        !(function n(o) {
          var t = g.popups.get("".concat(o, "Color.picker")),
            r = t
              .find(".fr-".concat(o, "-color .fr-active-item"))
              .attr("data-param1"),
      ...
      function e(o) {
        "REMOVE" !== o
          ? g.format.applyStyle("background-color", g.helpers.HEXtoRGB(o))
          : g.format.removeStyle("background-color"),
          g.popups.hide("backgroundColor.picker");
      }
      function c(o) {
        "REMOVE" !== o
          ? g.format.applyStyle("color", g.helpers.HEXtoRGB(o))
          : g.format.removeStyle("color"),
          g.popups.hide("textColor.picker");
      }
      return {
        showColorsPopup: function p(o) {
          ...
          if (
            (r ||
              (r = (function n(o) {
                ...
                g.opts.toolbarInline &&
                  0 < g.opts.colorsButtons.length &&
                  (t +=
                    '<div class="fr-buttons fr-colors-buttons fr-tabs">\n        '.concat(
                      g.button.buildList(g.opts.colorsButtons),
                      "\n        </div>"
                    ));
                var r,
                  e = "";
                r =
                  "textColor" === o
                    ? (g.opts.colorsHEXInput &&
                        (e = l
                          .replace(
                            /\[ID\]/g,
                            "fr-color-hex-layer-text-".concat(g.id)
                          )
                          .replace(/\[COMMAND\]/g, "customTextColor")),
                      { buttons: t, text_colors: s("text"), custom_color: e })
                    : (g.opts.colorsHEXInput &&
                        (e = l
                          .replace(
                            /\[ID\]/g,
                            "fr-color-hex-layer-background-".concat(g.id)
                          )
                    ...
                    g.events.on(
                      ...
                      function (o) {
                        ...
                        if (k.KEYCODE.TAB === r) {
                          ...
                          k.KEYCODE.ARROW_UP === r ||
                          k.KEYCODE.ARROW_DOWN === r ||
                          k.KEYCODE.ARROW_LEFT === r ||
                          k.KEYCODE.ARROW_RIGHT === r
                        ) {
                          ...
                          k.KEYCODE.ENTER === r && (g.button.exec(t), (e = !1));
                        return (
                          !1 === e && (o.preventDefault(), o.stopPropagation()),
                          e
                        );
                      },
                      !0
            ...
            if (
              (g.popups.setContainer("".concat(o, ".picker"), g.$tb),
              i("textColor" === o ? "text" : "background"),
              t.isVisible())
            ) {
              ...
              g.position.forSelection(r),
                g.popups.show("".concat(o, ".picker"));
        },
        background: e,
        customColor: function a(o) {
          var t = g.popups
            .get("".concat(o, "Color.picker"))
    ...
    k.DefineIcon("textColor", { NAME: "tint", SVG_KEY: "textColor" }),
    ...
    k.DefineIcon("colorsBack", { NAME: "arrow-left", SVG_KEY: "back" }),
