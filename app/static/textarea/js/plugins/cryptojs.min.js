...
!(function (t, e) {
  ...
  (t =
    t && t.hasOwnProperty("default")
      ? t["default"]
      : t).PLUGINS.cryptoJSPlugin = function (t) {
    var e,
      l,
      r,
      i,
            ...
            r =
              ...
              (function () {
                ...
                return function (t) {
                  var e;
                  return (
                    (r.prototype = t), (e = new r()), (r.prototype = null), e
                  );
                };
              })(),
            n = {},
    ...
    return (
      ...
      (function (t) {
        var e = yt,
          ...
          z = i.create([0, 1518500249, 1859775393, 2400959708, 2840853838]),
      ...
      (w = v.PBKDF2 =
        _.extend({
          cfg: _.extend({ keySize: 4, hasher: g, iterations: 1 }),
          init: function (t) {
          ...
          compute: function (t, e) {
            for (
              ...
              i.reset();
              for (var f = l.words, u = f.length, d = l, p = 1; p < h; p++) {
                (d = i.finalize(d)), i.reset();
                for (var _ = d.words, v = 0; v < u; v++) f[v] ^= _[v];
              }
              n.concat(l), c[0]++;
            }
      ...
      (z = b.EvpKDF =
        m.extend({
          cfg: m.extend({ keySize: 4, hasher: H, iterations: 1 }),
          init: function (t) {
            this.cfg = this.cfg.extend(t);
          },
          compute: function (t, e) {
      ...
      (k.EvpKDF = function (t, e, r) {
        return z.create(r).compute(t, e);
      }),
      (C = (A = yt).lib.WordArray),
      (E = A.algo),
      (D = E.SHA256),
      (R = E.SHA224 =
        D.extend({
      ...
      (A.SHA224 = D._createHelper(R)),
      (A.HmacSHA224 = D._createHmacHelper(R)),
      (P = (M = yt).lib),
      (F = P.Base),
      (W = P.WordArray),
      ((O = M.x64 = {}).Word = F.extend({
        init: function (t, e) {
      ...
      (O.WordArray = F.extend({
        ...
        toX32: function () {
          ...
          return W.create(r, this.sigBytes);
        },
        clone: function t() {
          for (
        ...
        var c = (o.SHA512 = e.extend({
          ...
          _doProcessBlock: function (t, e) {
            ...
            (u = i.low = u + A),
              ...
              (p = n.low = p + E),
              (n.high = d + C + (p >>> 0 < E >>> 0 ? 1 : 0)),
              (v = o.low = v + R),
              (o.high = _ + D + (v >>> 0 < R >>> 0 ? 1 : 0)),
              (g = s.low = g + P),
              (s.high = y + M + (g >>> 0 < P >>> 0 ? 1 : 0)),
              (w = c.low = w + W),
              (c.high = B + F + (w >>> 0 < W >>> 0 ? 1 : 0)),
              (S = a.low = S + I),
      ...
      (I.SHA384 = j._createHelper(N)),
      (I.HmacSHA384 = j._createHmacHelper(N)),
      yt.lib.Cipher ||
        ((T = (q = yt).lib),
        (Z = T.Base),
        (G = T.WordArray),
        ...
        (T.BlockCipher = Y.extend({
          cfg: Y.cfg.extend({ mode: rt, padding: it }),
          reset: function () {
            var t;
            Y.reset.call(this);
            var e = this.cfg,
        ...
        (ot = (q.format = {}).OpenSSL =
          {
            stringify: function (t) {
              var e = t.ciphertext,
                r = t.salt;
              return (
                r ? G.create([1398893684, 1701076831]).concat(r).concat(e) : e
              ).toString($);
            },
            parse: function (t) {
              var e,
              ...
              return (
                1398893684 == i[0] &&
                  1701076831 == i[1] &&
                  ((e = G.create(i.slice(2, 4))),
                  i.splice(0, 4),
                  (r.sigBytes -= 16)),
                nt.create({ ciphertext: r, salt: e })
              );
            },
          }),
        (st = T.SerializableCipher =
          Z.extend({
            cfg: Z.extend({ format: ot }),
        ...
        (ct = (q.kdf = {}).OpenSSL =
          {
            execute: function (t, e, r, i) {
              i || (i = G.random(8));
              var n = Q.create({ keySize: e + r }).compute(t, i),
                o = G.create(n.words.slice(e), 4 * r);
              return (
                (n.sigBytes = 4 * e), nt.create({ key: n, iv: o, salt: i })
              );
            },
          }),
        (at = T.PasswordBasedCipher =
          st.extend({
            cfg: st.cfg.extend({ kdf: ct }),
            encrypt: function (t, e, r, i) {
              ...
              i.iv = n.iv;
              var o = st.encrypt.call(this, t, e, n.key, i);
              return o.mixIn(n), o;
            },
            decrypt: function (t, e, r, i) {
              (i = this.cfg.extend(i)), (e = this._parse(e, i.format));
              var n = i.kdf.execute(r, t.keySize, t.ivSize, e.salt);
              return (i.iv = n.iv), st.decrypt.call(this, t, e, n.key, i);
            },
          }))),
      (yt.mode.CFB = (function () {
        var t = yt.lib.BlockCipherMode.extend();
        function o(t, e, r, i) {
          var n,
            o = this._iv;
          o
            ? ((n = o.slice(0)), (this._iv = undefined))
            : (n = this._prevBlock),
            i.encryptBlock(n, 0);
      ...
      (yt.mode.ECB =
        (((ht = yt.lib.BlockCipherMode.extend()).Encryptor = ht.extend({
          processBlock: function (t, e) {
      ...
      (yt.pad.Iso10126 = {
        pad: function (t, e) {
          var r = 4 * e,
            i = r - (t.sigBytes % r);
          t.concat(yt.lib.WordArray.random(i - 1)).concat(
            yt.lib.WordArray.create([i << 24], 1)
          );
        },
        unpad: function (t) {
          var e = 255 & t.words[(t.sigBytes - 1) >>> 2];
      ...
      (yt.pad.Iso97971 = {
        pad: function (t, e) {
          t.concat(yt.lib.WordArray.create([2147483648], 1)),
            yt.pad.ZeroPadding.pad(t, e);
        },
        unpad: function (t) {
          yt.pad.ZeroPadding.unpad(t), t.sigBytes--;
        },
      }),
      (yt.mode.OFB =
        ((lt = yt.lib.BlockCipherMode.extend()),
        (ft = lt.Encryptor =
          lt.extend({
            processBlock: function (t, e) {
              var r = this._cipher,
        ...
        (lt.Decryptor = ft),
        lt)),
      (yt.pad.NoPadding = { pad: function () {}, unpad: function () {} }),
      (dt = (ut = yt).lib.CipherParams),
      (pt = ut.enc.Hex),
      (ut.format.Hex = {
        stringify: function (t) {
          return t.ciphertext.toString(pt);
        },
        parse: function (t) {
          var e = pt.parse(t);
          return dt.create({ ciphertext: e });
        },
      }),
      (function () {
        var t = yt,
      ...
      (yt.mode.CTR =
        ((_t = yt.lib.BlockCipherMode.extend()),
        (vt = _t.Encryptor =
          _t.extend({
            processBlock: function (t, e) {
              var r = this._cipher,
