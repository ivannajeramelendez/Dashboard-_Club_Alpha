...
!(function (t, e) {
  ...
  (i = i && i.hasOwnProperty("default") ? i["default"] : i),
    Object.assign(i.DEFAULTS, { charCounterMax: -1, charCounterCount: !0 }),
    (i.PLUGINS.charCounter = function (n) {
      ...
      function t(t) {
        ...
        return (
          !(
            (!n.keys.ctrlKey(t) && n.keys.isCharacter(e)) ||
            e === i.KEYCODE.IME
          ) ||
          (t.preventDefault(),
          t.stopPropagation(),
      ...
      function a(t) {
        return n.opts.charCounterMax < 0
          ? t
          : e("<div>").html(t).text().length + o() <= n.opts.charCounterMax
          ? t
          : (n.events.trigger("charCounter.exceeded"), "");
      }
      function c() {
        if (n.opts.charCounterCount) {
          var t =
            o() +
            (0 < n.opts.charCounterMax ? "/" + n.opts.charCounterMax : "");
          r.text(
            "".concat(n.language.translate("Restante"), " : ").concat(t)
          ),
      ...
      return {
        _init: function u() {
          return (
            ...
            ((r = e(document.createElement("span")).attr(
              "class",
              "fr-counter"
            )).css("bottom", n.$wp.css("border-bottom-width")),
            n.$second_tb ? n.$second_tb.append(r) : n.$wp.append(r),
            n.events.on("keydown", t, !0),
            n.events.on("paste.afterCleanup", a),
            n.events.on("keyup contentChanged input", function () {
              n.events.trigger("charCounter.update");
            }),
            n.events.on("charCounter.update", c),
            n.events.trigger("charCounter.update"),
            void n.events.on("destroy", function () {
              e(n.o_win).off("resize.char".concat(n.id)),
                r.removeData().remove(),
                (r = null);
            }))
          );
