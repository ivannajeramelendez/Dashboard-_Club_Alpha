      ...
      if (
        ("Microsoft Internet Explorer" === navigator.appName
          ...
          : "Netscape" === navigator.appName &&
            ((e = navigator.userAgent),
            null !==
              new RegExp("Trident/.*rv:([0-9]{1,}[\\.0-9]{0,})").exec(e) &&
              (t = parseFloat(RegExp.$1))),
        !(
    ...
    (V.MODULES.node = function (a) {
      ...
      return {
        ...
        isFirstSibling: function u(e, t) {
          ...
          return (
            !n ||
            (n.nodeType === Node.TEXT_NODE && "" === n.textContent && u(n))
          );
        },
      ...
      return {
        ...
        html: function E(e, t, n, r) {
          ...
          return (
            ...
            (u = f.opts.htmlAllowedStyleProps.length
              ? new RegExp(
                  "((^|;|\\s)".concat(
              ...
              : null),
            (e = v(e, L, !0)),
            "undefined" != typeof f.opts.DOMPurify &&
              (e = f.opts.DOMPurify.sanitize(e, {
            ...
            (function a() {
              for (
                ...
                for (
                  ...
                  (!n[o].tagName && f.opts.htmlUntouched) ||
                  "LI" === n[o].tagName ||
                  "UL" == n[o].tagName ||
                  "OL" == n[o].tagName
                    ? (r = null)
  ...
  (V.LinkRegExCommon = "[".concat(
          ...
          (l.shared.$_events = l.shared.$_events || []),
            ...
            (function n() {
              s(l.$win, l._mousedown, function (e) {
                ...
                s(
                  l.$win,
                  "beforeinput cut copy keydown keyup touchmove touchend",
                  function (e) {
            ...
            (function o() {
              s(
                l.$el,
                "beforeinput keydown keypress keyup input",
                function (e) {
                  m(e.type, [e]);
                }
              );
            ...
            (function i() {
              s(l.$el, "focus", function (e) {
                h() &&
                  (c(!1),
                  !1 === d && (m(e.type, [e]), l.helpers.isMobile() && p()));
              }),
    ...
    (V.MODULES.commands = function (a) {
      ...
      var i = {
        ...
        insertHR: function () {
          ...
          a.opts.trackChangesEnabled &&
            (t = a.track_changes
              .wrapInTracking(s(t), "hrWrapper")
              .get(0).outerHTML);
          a.html.insert(t);
          var n,
            r = a.$el.find("hr#fr-just").length
              ? a.$el.find("hr#fr-just")
              : a.$el.find(".fr-just");
          r.removeAttr("id"), r.removeAttr("class");
          var o =
            a.opts.trackChangesEnabled &&
            "SPAN" === r[0].parentNode.tagName &&
            "P" === r[0].parentNode.parentNode.tagName;
          if (0 === r.next().length) {
            var i = a.html.defaultTag();
            i && !o
              ? r.after(s(a.doc.createElement(i)).append("<br>").get(0))
              : o
              ? r[0].parentNode.after(
                  s(a.doc.createElement(i)).append("<br>").get(0)
                )
              : r.after("<br>");
          }
          r.prev().is("hr")
            ...
            n ||
              void 0 === n ||
              ((e = l((e = "".concat(V.MARKERS, "<br>")))), r.after(e)),
            a.selection.restore();
        },
          ...
          (function r(n) {
            ...
            var e = a.$tb.find(
              '.fr-more-toolbar[data-name="'.concat(
                n.attr("data-group-name"),
                '"]'
              )
            );
            "trackChanges" === n.data("cmd") &&
              (e = a.$tb.find(
                '.fr-more-toolbar[data-name="'.concat(n.attr("id"), '"]')
              ));
            if (
              (a.$tb
                .find(".fr-open")
                .not(n)
                .not('[data-cmd="trackChanges"]')
                .removeClass("fr-open"),
              ...
              t.each(function (e, t) {
                ...
                0 != s(t).data("name").indexOf("moreRich-")
                  ? s(t).toggleClass("fr-expanded")
                  : n.parents('[data-name^="moreRich-"]').length ||
                    0 == s(t).data("name").indexOf("trackChanges-") ||
                    (s(t).find('[id^="trackChanges-"]').length &&
                      a.opts.trackChangesEnabled) ||
                    s(t).toggleClass("fr-expanded");
              }),
      ...
      function n(e, t) {
        if (
          !(
            (a.markdown &&
              a.markdown.isEnabled() &&
              ("bold" === e || "italic" === e || "underline" === e)) ||
            (a.opts.trackChangesEnabled && "markdown" === e)
          ) &&
          ...
          V.COMMANDS[e] &&
            ...
            ((!a.core.hasFocus() && r) ||
              ...
              (a.el.focus({ preventScroll: !0 }), a.events.trigger("focus")),
            V.COMMANDS[e] &&
              !1 !== V.COMMANDS[e].undo &&
      ...
      return {
        _startEnter: function S(e) {
          ...
          if (v.node.isEmpty(n, !0) && r) {
            ...
            var f =
              v.node.openTagString(l) + b(l).html() + v.node.closeTagString(l);
            (f = f.replace(/<span id="fr-break"><\/span>/g, c)),
              b(l).replaceWith(f),
              v.$el.find("li:empty").remove(),
              v.$el.find("li > p > span:empty").length &&
                v.$el
                  .find("li > p > span:empty")[0]
                  .parentNode.parentNode.remove();
          } else if ((o && r) || !v.node.isEmpty(n, !0)) {
            var p = "<br>",
              h = e.parentNode;
            for (
              h && "A" === h.tagName && (h = null);
              h && "LI" !== h.tagName;
            ...
            t = E(n);
            for (
              var g = "".concat(V.MARKERS, "<br>"), C = e.parentNode;
              C && "LI" !== C.tagName;
            ...
            if (t.parentNode && "LI" === t.parentNode.tagName)
              ...
              i
                ? b(t).after("<".concat(i, ">").concat(g, "</").concat(i, ">"))
                : b(t).after(g);
            b(n).remove();
          } else
            (t = E(n)).parentNode && "LI" === t.parentNode.tagName
              ? r
                ? b(t.parentNode).before(
                    "".concat(v.node.openTagString(n) + V.MARKERS, "<br></li>")
                  )
                : b(t.parentNode).after(
                    "".concat(v.node.openTagString(n) + V.MARKERS, "<br></li>")
                  )
              : i
              ? b(t).before(
        ...
        _middleEnter: function c(e) {
          ...
          (n =
            ...
            o +
            V.MARKERS +
            (v.opts.keepFormatOnDelete ? V.INVISIBLE_SPACE : "")),
            b(e).replaceWith('<span id="fr-break"></span>');
          var l =
            v.node.openTagString(t) + b(t).html() + v.node.closeTagString(t);
        ...
        _backspace: function d(e) {
          ...
          if (n) {
            ...
            r.length &&
              ...
              b(t)
                ...
                .each(function () {
                  this.parentNode === t &&
                    b(this).replaceWith(
                      b(this).html() + (v.node.isEmpty(this) ? "" : "<br>")
                    );
                });
            for (var o, i = v.node.contents(t)[0]; i && !v.node.isList(i); )
              (o = i.nextSibling), b(n).append(i), (i = o);
            for (n = t.previousSibling; i; )
              (o = i.nextSibling), b(n).append(i), (i = o);
            1 < (r = v.node.contents(n)).length &&
              "BR" === r[r.length - 1].tagName &&
              b(r[r.length - 1]).remove(),
              b(t).remove();
          } else {
            ...
            if (
              ...
              l && 0 === b(t).find(v.html.blockTagsQuery()).length
                ? b(a).before(
                    "<".concat(l, ">").concat(b(t).html(), "</").concat(l, ">")
                  )
                : b(a).before(b(t).html());
            }
            b(t).remove(),
        ...
        _del: function f(e) {
          ...
          if (r) {
            ...
            for (
              var o, i = e, a = v.node.contents(r)[0];
              a && !v.node.isList(a);

            )
              (o = a.nextSibling), b(i).after(a), (i = a), (a = o);
            ...
            if (((s = s.nextSibling), v.node.isBlock(s))) {
              if (V.NO_DELETE_TAGS.indexOf(s.tagName) < 0) {
                if (
                  (b(e).replaceWith(V.MARKERS),
                  (t = v.node.contents(n)).length &&
                    "BR" === t[t.length - 1].tagName &&
                    b(t[t.length - 1]).remove(),
                  s.isContentEditable &&
                    "DIV" === s.tagName &&
                    (!v.node.isBlock(s.previousSibling) ||
                      "DIV" === s.previousSibling.tagName))
                )
                  return;
              ...
              for (
                (t = v.node.contents(n)).length &&
                  ...
                  b(t[t.length - 1]).remove(),
                  b(e).replaceWith(V.MARKERS);
                s && !v.node.isBlock(s) && "BR" !== s.tagName;
    ...
    (V.MODULES.cursor = function (g) {
        ...
        return (
          ...
          (g.node.isBlock(e)
            ? "P" !== e.tagName ||
              ...
              !e.parentElement ||
              "OL" !== e.nextElementSibling.tagName ||
          ...
          (!!g.node.isBlock(e) ||
            ...
            0 === e.previousSibling.textContent.replace(/\u200b/g, "").length
              ...
              : !e.previousSibling &&
                (!(
                  e.previousSibling ||
                  !g.node.hasClass(e.parentNode, "fr-inner")
                ) ||
                  u(e.parentNode))))
        );
      }
        ...
        return (
          ...
          0 === e.nextSibling.textContent.replace(/\u200b/g, "").length
            ...
            : !(
              ...
              (e.parentNode === t || v(e.parentNode, t)))
        );
      }
      function b(e) {
        return (
          0 < C(e).parentsUntil(g.$el, "LI").length &&
          0 === C(e).parentsUntil("LI", "TABLE").length
        );
      }
      function L(e, t) {
        var n = new RegExp(
      ...
      function E(e) {
        ...
        if (
          (!g.node.isBlock(n) || (n.lastChild && o && 0 <= r.indexOf(o))) &&
          g.node.isEditable(n)
        ) {
          for (
            t = g.node.contents(n);
          ...
          if (n.nodeType === Node.TEXT_NODE) {
            ...
            ((g.opts.enter === V.ENTER_BR &&
              ...
              (0 === s.length &&
                ...
                "TD" !== e.parentNode.tagName &&
                "LI" !== e.parentNode.tagName &&
                i !== String.fromCharCode(8203))) &&
              (e.insertAdjacentHTML("beforebegin", V.INVISIBLE_SPACE),
              (n = n.nextSibling)),
              g.opts.trackChangesEnabled &&
                0 === n.textContent.length &&
                C(n.parentElement).data("tracking") &&
                0 ===
                  C(n.parentElement).find("[data-tracking-deleted=true]")
                    .length &&
                (C(e).insertBefore(n.parentElement),
            ...
            g.node.isDeletable(n)
              ...
              : !1 !== g.events.trigger("node.remove", [C(n)]) &&
                (C(n).after(V.MARKERS), C(n).remove());
        } else if (
          V.NO_DELETE_TAGS.indexOf(n.tagName) < 0 &&
          (g.node.isEditable(n) || g.node.isDeletable(n))
        )
          if (g.node.isDeletable(n)) C(e).replaceWith(V.MARKERS), C(n).remove();
          else if (g.node.isEmpty(n) && !g.node.isList(n))
            C(n).remove(), C(e).replaceWith(V.MARKERS);
          else {
            for (
              g.node.isList(n) && (n = C(n).find("li").last().get(0)),
                (t = g.node.contents(n)) &&
                  0 < t.length &&
                  "BR" === t[t.length - 1].tagName &&
                  C(t[t.length - 1]).remove(),
                t = g.node.contents(n);
      ...
      function i(e) {
        ...
        if (n && "BLOCKQUOTE" === n.tagName) {
          var r = g.node.deepestParent(e, [
            C(e).parentsUntil(g.$el, "BLOCKQUOTE").get(0),
          ]);
          r && r.nextSibling && (n = r);
        }
        if (null !== n) {
          ...
          if (
            ...
            if (g.node.isDeletable(i))
              C(i).remove(), C(e).replaceWith(V.MARKERS);
            else if (g.node.isBlock(i) && g.node.isEditable(i))
              if (g.node.isList(i))
                if (g.node.isEmpty(n, !0))
                  C(n).remove(), C(i).find("li").first().prepend(V.MARKERS);
                else {
                  var a = C(i).find("li").first();
                  "BLOCKQUOTE" === n.tagName &&
                    (o = g.node.contents(n)).length &&
                    g.node.isBlock(o[o.length - 1]) &&
                    (n = o[o.length - 1]),
                ...
                if (
                  ...
                  for (
                    o = g.node.contents(n);
                    o.length && g.node.isBlock(o[o.length - 1]);

                  )
                    (n = o[o.length - 1]), (o = g.node.contents(n));
                else if (
                  ...
                  for (
                    o = g.node.contents(i);
                    o.length && g.node.isBlock(o[0]);

                  )
                    (i = o[0]), (o = g.node.contents(i));
                C(e).replaceWith(V.MARKERS),
      ...
      function n(e) {
        ...
        if ("BR" === (n = n.nextSibling).tagName && g.node.isEditable(n))
          if (n.nextSibling) {
            if (
              g.node.isBlock(n.nextSibling) &&
              g.node.isEditable(n.nextSibling)
            ) {
            ...
            if (b(e)) g.cursorLists._del(e);
              ...
              g.node.deepestParent(n) &&
                ((!g.node.isEmpty(g.node.blockParent(n)) ||
                  (g.node.blockParent(n).nextSibling &&
                    V.NO_DELETE_TAGS.indexOf(
                      g.node.blockParent(n).nextSibling.tagName
                    )) < 0) &&
                  C(n).remove(),
                n &&
                  n.parentNode &&
        ...
        if (!g.node.isBlock(n) && g.node.isEditable(n)) {
          for (
            ...
            (n = t[0]), (t = g.node.contents(n));
          n.nodeType === Node.TEXT_NODE
            ? (C(n).before(V.MARKERS),
              n.textContent.length &&
          ...
          if (g.node.isDeletable(n)) C(e).replaceWith(V.MARKERS), C(n).remove();
            ...
            e.previousSibling
              ? (C(n).find("li").first().prepend(e),
                g.cursorLists._backspace(e))
              : (C(n).find("li").first().prepend(V.MARKERS), C(e).remove());
          else if (
            ((t = g.node.contents(n)) &&
              0 < t.length &&
              "BR" === t[0].tagName &&
      ...
      function a() {
        for (
          var e = g.el.querySelectorAll("blockquote:empty"), t = 0;
          t < e.length;
          t++
        )
        ...
        if (null === o)
          ...
          (r = g.html.defaultTag()) &&
            ...
            o.tagName === r.toUpperCase() &&
              (d = g.node.openTagString(C(o).clone().removeAttr("id").get(0))));
          do {
            if (
              ((i = i.parentNode), !t || i !== o || (t && !g.node.isBlock(o)))
            )
              if (
                ((l += g.node.closeTagString(i)), i === o && g.node.isBlock(o))
              )
                c = d + c;
              else {
                var p =
                  ("A" === i.tagName || g.node.hasClass(i, "fa")) && v(e, i)
                    ? "fr-to-remove"
                    : "";
                c =
                  "isPasted" === i.getAttribute("id")
                    ? g.node.openTagString(
                        C(i).clone().attr("style", "").addClass(p).get(0)
                      ) + c
                    : g.node.openTagString(C(i).clone().addClass(p).get(0)) + c;
              }
          } while (i !== o);
          (a =
            l +
            a +
            c +
            (e.parentNode === o && g.node.isBlock(o) ? "" : V.INVISIBLE_SPACE) +
            V.MARKERS),
            g.node.isBlock(o) &&
              !C(o).find("*").last().is("br") &&
              C(o).append("<br/>"),
            ...
            C(e).remove(),
            (o.nextSibling && !g.node.isBlock(o.nextSibling)) ||
              g.node.isBlock(o) ||
              C(o).after("<br>"),
            (s = (s =
              !t && g.node.isBlock(o)
                ? g.node.openTagString(o) + C(o).html() + f
                : g.node.openTagString(o) +
                  C(o).html() +
                  g.node.closeTagString(o)).replace(
      ...
      function S(e, t, n) {
        ...
        if (null === r)
          g.html.defaultTag() && e.parentNode === g.el
            ...
            : ((e.nextSibling && !g.node.isBlock(e.nextSibling)) ||
                C(e).after("<br>"),
              C(e).replaceWith("<br>".concat(V.MARKERS)));
        else if (
          ...
          do {
            ...
            if (
              ...
              if (!t || o !== r || (t && !g.node.isBlock(r))) {
                ...
                var c =
                  ("A" == o.tagName && v(e, o)) || g.node.hasClass(o, "fa")
                    ? "fr-to-remove"
                    : "";
                (s =
                  g.node.openTagString(
                    C(o).clone().addClass(c).removeAttr("id").get(0)
                  ) + s),
                  g.opts.enter !== V.ENTER_DIV &&
                    o === r &&
                    "DIV" === r.tagName &&
                    ((a = "<br>"), (s = ""));
          ...
          var p =
            g.node.openTagString(r) + C(r).html() + g.node.closeTagString(r);
      ...
      return {
        enter: function M(e) {
          ...
          for (var n = t.parentNode; n && !g.node.isElement(n); ) {
            if ("false" === n.getAttribute("contenteditable"))
              return C(t).replaceWith(V.MARKERS), g.selection.restore(), !1;
              ...
              ? !b(t) || e || r
                ? (function f(e, t, n) {
                    ...
                    if (o && "TABLE" === o.tagName)
                      return C(o).find("td, th").first().prepend(e), f(e, t, n);
                    if (o && "BLOCKQUOTE" === o.tagName)
                      if (m(e, o)) {
                        if (!t)
                          return (
                            (r = g.html.defaultTag())
                              ...
                              : C(o).before("".concat(V.MARKERS, "<br>")),
                            C(e).remove(),
                            !1
                          );
                    ...
                    if (null === o)
                      ...
                      if (((r = g.html.defaultTag()), g.node.isBlock(o)))
                        if (("PRE" === o.tagName && (t = !0), t))
                          C(e).remove(), C(o).prepend("<br>".concat(V.MARKERS));
                        else if (
                          (e.nextSibling && "IMG" == e.nextSibling.tagName) ||
                          (e.nextSibling &&
                          ...
                          if (
                            g.opts.keepFormatOnDelete ||
                            "DIV" === o.tagName ||
                            "div" === g.html.defaultTag()
                          )
                            if (
                              (!g.opts.keepFormatOnDelete &&
                                "DIV" === o.tagName) ||
                              ...
                              "DIV" !== o.tagName &&
                              "div" !== g.html.defaultTag() &&
                              u(g.selection.get().focusNode)
                            )
                              C(o).before(
                                ""
                                  .concat(
                                    g.node.openTagString(
                                      C(o).clone().removeAttr("id").get(0)
                                    ),
                                    "<br>"
                                  )
                                  .concat(g.node.closeTagString(o))
                              );
                            else {
                              for (
                                var i = e, a = V.INVISIBLE_SPACE;
                                i !== o && !g.node.isElement(i);

                              )
                                (i = i.parentNode),
                                  (a =
                                    g.node.openTagString(i) +
                                    a +
                                    g.node.closeTagString(i));
                              C(o).before(a);
                            }
                          else
                            C(o).before(
          ...
          if (g.$oel[0].offsetHeight > o) {
            ...
            if (i) {
              ...
              g.opts.scrollableContainer &&
                g.opts.enter !== V.ENTER_BR &&
                "BR" === i.tagName &&
                (s = a = i.parentNode.offsetTop),
                i.parentNode && "TD" === i.parentNode.tagName && o < s
                  ...
                  : g.opts.scrollableContainer &&
                    s + 2 * g.$tb.height() >
                      g.$sc[0].scrollTop + C(g.$sc).height() &&
                    g.$sc[0].scroll(
                      0,
                      a - C(g.$sc).height() + 2 * g.$tb.height()
                    );
            }
            ...
            if (l) {
              ...
              g.opts.enter !== V.ENTER_BR &&
                "BR" === l.tagName &&
                (d = c = l.parentNode.offsetTop),
                ((g.opts.iframe &&
                  d + 2 * g.$tb.height() >
                    g.$sc[0].scrollTop + C(g.$sc).height()) ||
                  d + 2 * g.$tb.height() > C(g.$sc).height()) &&
                  g.$sc[0].scroll(
                    0,
                    c - C(g.$sc).height() + 2 * g.$tb.height()
                  );
            }
          }
        },
        backspace: function s() {
          ...
          if (r) {
            ...
            o &&
              ...
              (1 === o.length
                ? C(r).remove()
                : (r.textContent = r.textContent.substr(0, o.length - L(o))));
          }
          return (
            h(t)
              ...
              ? b(t) && m(t, C(t).parents("li").first().get(0))
                ...
                : (function c(e) {
                    for (
                      ...
                      !n.previousSibling &&
                      "BLOCKQUOTE" !== n.tagName &&
                      n.parentElement !== g.el &&
                      !g.node.hasClass(n.parentElement, "fr-inner") &&
                      V.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0;

                    )
                      n = n.parentElement;
                    if (n && "BLOCKQUOTE" === n.tagName) {
                      var o = g.node.deepestParent(e, [
                        C(e).parentsUntil(g.$el, "BLOCKQUOTE").get(0),
                      ]);
                      ...
                      if (g.node.isBlock(n) && g.node.isEditable(n))
                        if (a && V.NO_DELETE_TAGS.indexOf(a.tagName) < 0) {
                          if (g.node.isDeletable(a))
                            C(a).remove(), C(e).replaceWith(V.MARKERS);
                            ...
                            if (g.node.isBlock(a))
                              if (g.node.isEmpty(a) && !g.node.isList(a))
                                ...
                                if (
                                  (g.node.isList(a) &&
                                    (a = C(a).find("li").last().get(0)),
                                  (i = g.node.contents(a)).length &&
                                    "BR" === i[i.length - 1].tagName &&
                                    C(i[i.length - 1]).remove(),
                                  "BLOCKQUOTE" === a.tagName &&
                                    "BLOCKQUOTE" !== n.tagName)
                                )
                                  for (
                                    i = g.node.contents(a);
                                    i.length && g.node.isBlock(i[i.length - 1]);
                                  ...
                                  for (
                                    i = g.node.contents(r);
                                    i.length && g.node.isBlock(i[0]);

                                  )
                                    (r = i[0]), (i = g.node.contents(r));
                                if (g.node.isEmpty(n))
                                  C(e).remove(), g.selection.setAtEnd(a, !0);
                                else {
                                  C(e).replaceWith(V.MARKERS);
                                  var s = a.childNodes;
                                  g.node.isBlock(s[s.length - 1])
                                    ? C(s[s.length - 1]).append(r.innerHTML)
                                    : C(a).append(r.innerHTML);
                                }
                                C(r).remove(),
        ...
        del: function r() {
          ...
          C(e).remove(),
            a(),
            g.html.fillEmptyBlocks(!0),
            g.opts.htmlUntouched || (g.html.cleanEmptyTags(), g.clean.lists()),
            g.spaces.normalizeAroundCursor(),
            g.selection.restore();
        },
        isAtEnd: v,
      ...
      return {
        _init: function x() {
          ...
          for (var n, r, o, i = !(f.ul = !0), a = 0, s = 0; s < e.length; s++) {
            var l =
                ((r = e[s]),
                4 === (o = (M(r) || "").split("|")).length && "V3" === o[0]
                  ? [o[1], o[3], o[2]]
                  : [null, null, ""]),
              c = l[2];
            if (
              c === M(p(M("LGnD1KNZf1CPBYCAZB-8F3UDSLLSG1VFf1A3C2=="))) ||
              0 <= c.indexOf(T, c.length - T.length) ||
              C(T) ||
              m()
            ) {
              if (
    ...
    (V.MODULES.format = function (N) {
        ...
        if (e) {
          if (
            (N.node.isBlock(e) &&
              ...
              "false" === e.getAttribute("contenteditable")) ||
            (e.parentNode &&
              e.parentNode.hasAttribute("contenteditable") &&
              "false" === e.parentNode.getAttribute("contenteditable"))
          ) {
            if (e.nextSibling && T(e.nextSibling).hasClass("fr-marker")) return;
            if (e.nextSibling) return void v(e.nextSibling, t, n);
            if (e.parentNode && N.node.isEditable(e.parentNode))
              return void v(e.parentNode, t, n);
          }
          for (; e && e.nodeType === Node.COMMENT_NODE; ) e = e.nextSibling;
          if (e) {
            if (N.node.isBlock(e) && "HR" !== e.tagName && "LI" !== e.tagName)
              return (
                N.node.hasClass(e.firstChild, "fr-marker")
                  ? v(e.firstChild.nextSibling, t, n)
                  : v(e.firstChild, t, n),
                !1
              );
                ...
                "background-color" !== o &&
                  ...
                  (function p(e, t) {
                    ...
                    for (n = 0; n < r.length; n++)
                      0 <= ["UL", "OL", "LI"].indexOf(r[n].tagName) &&
                        "" === r[n].style[t] &&
                        T(r[n]).css(t, "initial");
                  })(r, o)));
            for (
              var l = e;
              l &&
              !T(l).hasClass("fr-marker") &&
              0 === T(l).find(".fr-marker").length &&
              "UL" !== l.tagName &&
              "OL" !== l.tagName;

            ) {
              var c = l;
              if ("SPAN" === l.tagName && T(l).hasClass("fr-tracking-deleted"))
                l = l.nextSibling;
              else {
                if (N.node.isBlock(l) && "HR" !== e.tagName)
                  return v(l.firstChild, t, n), !1;
                if ("SPAN" === l.tagName && N.node.isEditable(l))
                  return (
                    s.is(":empty") && s.remove(), v(l.firstChild, t, n), !1
                  );
                if (
                  l.tagName &&
                  ...
                  return void v(l.nextSibling, t, n);
                if (!N.node.isEditable(l.parentNode))
                  return N.selection.restore(), void N.toolbar.disable();
                (l = l.nextSibling), s.append(c);
              }
            }
            if (l)
              (T(l).find(".fr-marker").length ||
                "UL" === l.tagName ||
                "OL" === l.tagName) &&
                v(l.firstChild, t, n);
            else {
              for (
                var d = s.get(0).parentNode;
                d && !d.nextSibling && !N.node.isElement(d);
      ...
      function n(e, t) {
        ...
        if (
          ...
          r.get(0).nextSibling &&
            N.node.isBlock(r.get(0).nextSibling) &&
            !r.get(0).previousSibling &&
            "LI" === r.get(0).parentNode.tagName &&
            r.get(0).nextSibling.prepend(r.get(0)),
            r.replaceWith(
              (function l(e, t) {
                var n = "<".concat(e);
                for (var r in t)
          ...
          var o,
            i =
              N.$el.find('.fr-marker[data-type="true"]').length &&
              N.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling;
          v(i, e, t), T(i).parent().find("a:empty").remove();
          do {
            for (
              o = N.$el.find("".concat(M(e, t), " > ").concat(M(e, t))), n = 0;
              n < o.length;
              n++
            )
          ...
          for (n = 0; n < a.length; n++) {
            var s = T(a[n]);
            !0 === s.data("type")
              ? A(s.get(0).nextSibling, M(e, t)) && s.next().prepend(s)
              : A(s.get(0).previousSibling, M(e, t)) && s.prev().append(s);
          }
          N.selection.restore();
        }
      }
      function x(e, t, n, r) {
        ...
        if (e.parents(t).length || void 0 === t) {
          var i,
            ...
            l = e.parent();
          if (
            ("A" === l[0].tagName && (l = l.parent()),
            l.is(N.$el) || N.node.isBlock(l.get(0)))
          )
            return !1;
          for (
            ;
            !(
              N.node.isBlock(l.parent().get(0)) ||
              (void 0 !== t && A(l.get(0), M(t, n)))
            );

          )
            (a += N.node.closeTagString(l.get(0))),
              (s = N.node.openTagString(l.get(0)) + s),
              (l = l.parent());
          ...
          return (
            ...
            (i = l
              ...
              .replace(
                /<span id="mark"><\/span>/,
                a +
                  N.node.closeTagString(l.get(0)) +
                  s +
                  c +
                  a +
                  N.node.openTagString(l.get(0)) +
                  s
              )),
            l.replaceWith(
              N.node.openTagString(l.get(0)) +
      ...
      function r(e, t) {
        ...
        !(function y(e, t, n, r) {
          for (
            ...
            if (
              (l.innerHTML &&
                8203 == l.innerHTML.charCodeAt() &&
                l.tagName.toLocaleLowerCase() == n &&
                l.childNodes.length < 2 &&
                !N.helpers.isMobile() &&
                (l.outerHTML = l.innerHTML),
              N.node.hasClass(l, "fr-marker"))
            )
              t = (t + 1) % 2;
            else if (t)
              if (0 < T(l).find(".fr-marker").length) t = y(T(l), t, n, r);
                ...
                (o =
                  "LI" === l.tagName
                    ? l
                    : T(l).parentsUntil(N.$el, "li").get(0)) &&
                  (void 0 === n || 0 <= ["strong", "em"].indexOf(n)) &&
                  (n ? T(o).css(i[n].prop, "") : (o.style = "")),
                  (o = l.parentNode !== N.el ? l.parentNode : null) &&
                  1 === o.nodeType &&
                  "a" !== n &&
                  o.hasAttribute("style") &&
                  ["P", "EM", "UL", "LI", "OL", "H1", "SPAN"].indexOf(
                    o.tagName
                  ) < 0
                    ? (o.style = "")
                    : l &&
                      1 === l.nodeType &&
                      l.hasAttribute("style") &&
                      [
                        "p",
                        "strong",
                        "u",
                      ...
                      (N.browser.msie
                        ...
                        : (l.style = ""));
                for (
                  var c = T(l).find(n || "*:not(br)"), d = c.length - 1;
                  0 <= d;
                  d--
                ) {
                  var f = c[d];
                  (o =
                    "LI" === f.tagName
                      ? f
                      : T(f).parentsUntil(N.$el, "li").get(0)) &&
                    (!n || 0 <= ["strong", "em"].indexOf(n)) &&
                    (n ? T(o).css(i[n].prop, "") : (o.style = "")),
                    "A" === f.tagName ||
                    N.node.isBlock(f) ||
                    N.node.isVoid(f) ||
                    (void 0 !== n && !A(f, M(n, r)))
                      ? N.node.isBlock(f) &&
                        void 0 === n &&
                        "TABLE" !== l.tagName &&
                        N.node.clearAttributes(f)
                      : N.node.hasClass(f, "fr-clone") ||
                        N.node.hasClass(f, "fr-tracking-deleted") ||
                        T(f).data("tracking") ||
                ...
                A(l, M(n, r))
                  ? N.node.isBlock(l) ||
                    (N.node.hasClass(l, "fr-clone") ||
                    N.opts.trackChangesEnabled
                      ? !N.node.hasClass(l, "fr-clone") &&
                        N.opts.trackChangesEnabled &&
                        l.parentNode &&
                        (l.outerHTML = l.innerHTML)
        ...
        if (l) {
          var c = N.node.blockParent(l),
            ...
            p = f.startOffset,
            h = f.endOffset;
          N.selection.text().replace(/\u200B/g, "").length ||
            (function S(e, t) {
              if (e && t) {
                if (
                  (e.isSameNode(t)
          ...
          if (l.nodeType === Node.TEXT_NODE) {
            if (!d || (!N.selection.text().length && p === h)) {
              ...
              if (N.browser.msie) {
                ...
                N.selection.get().removeAllRanges(),
                  C.setStart(l, g),
                  C.setEnd(l, g),
                  N.selection.get().addRange(C);
      ...
      function t(e, t) {
        ...
        if (N.selection.isCollapsed()) {
          ...
          if (
            N.node.openTagString(d.get(0)) ===
            '<span style="'.concat(e, ": ").concat(d.css(e), ';">')
          ) {
            if (N.node.isEmpty(d.get(0)))
              (c = T(N.doc.createElement("span"))
            ...
            N.node.isEmpty(d.get(0)) && d.is("span")
          ...
          if (
            ...
            null === t ||
              ("color" === e &&
                0 < N.$el.find(".fr-marker").parents("u, a").length))
          ) {
            ...
            for (n = 0; n < p.length; n++)
              if (
                ...
                for (
                  ;
                  N.node.isFirstSibling(r.get(0)) &&
                  !r.parent().is(N.$el) &&
                  !N.node.isElement(r.parent().get(0)) &&
                  !N.node.isBlock(r.parent().get(0));
          ...
          for (
            t && (u.style = "".concat(e, ": ").concat(t, ";")),
              v(h, "span", u),
              N.$el.find(".fr-marker + .fr-unprocessed").each(function () {
              ...
              (t || "").match(/\dem$/) &&
                N.$el.find("span.fr-unprocessed").removeClass("fr-unprocessed");
            0 < N.$el.find("span.fr-unprocessed").length;
            ...
            if (
              ...
              c.parent().is("span") &&
                1 === c.parent().get(0).childNodes.length)
            ) {
              var g = t;
            ...
            for (
              i = c.find("span"),
                o &&
                  "background-color" !== e &&
                  (o.normalize(), (i = T(o).find("span:not(.fr-unprocessed)"))),
                n = i.length - 1;
              0 <= n;
              n--
            )
        ...
        !(function m() {
          var e;
          for (; 0 < N.$el.find(".fr-split:empty").length; )
            N.$el.find(".fr-split:empty").remove();
          N.$el.find(".fr-split").removeClass("fr-split"),
            N.$el.find('[style=""]').removeAttr("style"),
            N.$el.find('[class=""]').removeAttr("class"),
            N.html.cleanEmptyTags();
          for (var t = N.$el.find("span"), n = t.length - 1; 0 <= n; n--) {
            var r = t[n];
            (r.attributes && 0 !== r.attributes.length) ||
              T(r).replaceWith(r.innerHTML);
          }
          N.el.normalize();
          ...
          for (e = 0; e < o.length; e++) {
            ...
            i.get(0).previousSibling === a.get(0) &&
              N.node.openTagString(i.get(0)) ===
                N.node.openTagString(a.get(0)) &&
          ...
          N.$el.find("span[style] span[style]").each(function () {
            if (0 <= T(this).attr("style").indexOf("font-size")) {
              ...
              e.attr("style") &&
                ...
                (T(this).attr(
                  "style",
                  "".concat(T(this).attr("style"), ";").concat(e.attr("style"))
                ),
                x(T(this), "span[style]", {}, !1));
            }
          }),
            N.el.normalize(),
            N.selection.restore();
      ...
      function b(e) {
        var t, n, r, o, i, a;
        if (
          (t = "LI" === e.tagName ? e : T(e).parentsUntil(N.$el, "li").get(0))
        ) {
          if ((a = N.selection.info(t)).atStart && a.atEnd) return t;
          if (
            a.atStart &&
            !a.atEnd &&
            ((n = T(t).find(".fr-marker[data-type=false]").get(0)),
            (r = T(n).parentsUntil(N.$el, "li").get(0)),
            (o = T(n).parent().get(0)),
            ((i = n.nextSibling) && 0 <= ["UL", "OL"].indexOf(i.tagName)) ||
              !r.isSameNode(t) ||
              (!i &&
                ("LI" === o.tagName ||
                  !o.nextSibling ||
                  0 <= ["UL", "OL"].indexOf(o.nextSibling.tagName) ||
                  N.node.isVoid(o.nextSibling))))
          )
            return t;
        }
      }
      function L(e, t, n) {
        ...
        for (r = a.length - 1; 0 <= r; r--)
          (o = a[r]),
            (i = t),
            0 === T(o).attr("style").indexOf("".concat(i, ":")) ||
              0 <= T(o).attr("style").indexOf(";".concat(i, ":")) ||
              0 <= T(o).attr("style").indexOf("; ".concat(i, ":")) ||
              s.push(a[r]);
        if ((a = a.not(s)).length) {
          for (
            ...
            (p = p.parentNode),
              T(p).addClass("fr-split"),
              (l += N.node.closeTagString(p)),
              (c =
                N.node.openTagString(T(p).clone().addClass("fr-split").get(0)) +
                c),
              a.get(0) !== p &&
                ((d += N.node.closeTagString(p)),
                (f =
                  N.node.openTagString(
                    T(p).clone().addClass("fr-split").get(0)
                  ) + f)),
              a.get(0) !== p;
      ...
      function o(e, t) {
        ...
        if (
          ...
          for (; !N.node.isBlock(r.parentNode) && !r.nextSibling; )
            r = r.parentNode;
          r.nextSibling && (r = r.nextSibling);
        }
        for (
          var o = r;
          o && o.nodeType === Node.ELEMENT_NODE && !A(o, M(e, t));
        ...
        for (
          ...
          i && i.nodeType === Node.ELEMENT_NODE && i !== N.el && !A(i, M(e, t));
        ...
        if (!c.html.isPreformatted(i)) {
          ...
          for (var s = "", l = 0; l < o.length; l++)
            ...
            !(
              ...
              (n &&
                r &&
                0 <= ["STRONG", "U", "EM"].indexOf(n.tagName) &&
                "BR" === r.tagName)
            )
              ? (s += o[l])
              : (s += V.UNICODE_NBSP);
          c.browser.chrome &&
            ...
            ((r &&
              ...
              "BR" === r.nextSibling.nextSibling.tagName) ||
              (r && "BR" === r.tagName)) &&
              ...
              if (o.nextSibling === a || a.nextSibling === o) {
                for (
                  var p = o.nextSibling === a ? o : a,
                    h = p === o ? a : o,
                    u = p.previousSibling;
                  u && u.nodeType === Node.TEXT_NODE && 0 === u.length;

                )
                  (u = (d = u).previousSibling), y(d).remove();
                if (u && u.nodeType === Node.TEXT_NODE)
                  for (
                    ;
                    u &&
                    u.previousSibling &&
                    u.previousSibling.nodeType === Node.TEXT_NODE;
                ...
                if (
                  (u && (E.node.isVoid(u) || E.node.isBlock(u)) && (u = null),
              ...
              if (!l) {
                ...
                (v =
                  (E.browser.chrome || E.browser.edge) && o.nextSibling === a
                    ? ((m = M(a, i, !0) || i.setStartAfter(a)),
                      M(o, i, !1) || i.setEndBefore(o))
                    : (o.previousSibling === a && (a = (o = a).nextSibling),
                      (a.nextSibling && "BR" === a.nextSibling.tagName) ||
                        ...
                        (s = y(E.doc.createTextNode("\u200b")).get(0))),
                      (m =
                        M(o, i, !0) || (y(o).before(s) && i.setStartBefore(o))),
      ...
      function o(e) {
        ...
        if (E.win.getSelection) {
          ...
          E.doc.selection &&
            ...
            ((n = (t =
              E.doc.selection.createRange()).duplicate()).moveToElementText(e),
    ...
    (V.MODULES.html = function (w) {
      var u = w.$;
      function d() {
        return w.opts.enter === V.ENTER_P
          ? "p"
          : w.opts.enter === V.ENTER_DIV
          ? "div"
          : w.opts.enter === V.ENTER_BR
          ? null
          : void 0;
      }
      function s(e, t) {
      ...
      function i(e) {
        ...
        for (
          l += ",".concat(V.VOID_ELEMENTS.join(",")),
            l += ", .fr-inner",
            l += ",".concat(
              w.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"),
              ":not(.fr-marker)"
            ),
            t = r.length - 1;
          0 <= t;
          ...
          if (
            ...
            for (
              var c = w.node.contents(r[t]), d = !1, f = 0;
              f < c.length;
              f++
            )
              if (
      ...
      function e(e) {
        ...
        (r = u.merge(r, w.opts.htmlAllowedEmptyTags)),
          (r =
            void 0 === e
              ? u.merge(r, V.BLOCK_TAGS)
              : u.merge(r, V.NO_DELETE_TAGS)),
          (t = w.el.querySelectorAll(
            "*:empty:not(".concat(
              r.join("):not("),
        ...
        do {
          ...
          )).length || (t = w.el.querySelectorAll("a[href]:not([name]):empty"));
        } while (t.length && n);
      }
      function a(e, t) {
        var n = d();
        if ((t && (n = "div"), n)) {
          for (
            var r = w.doc.createDocumentFragment(),
              o = null,
              i = !1,
              a = e.firstChild,
              s = !1;
            ...
            if (
              ...
              (w.node.isBlock(a) ||
                (0 <=
                  w.opts.htmlDoNotWrapTags.indexOf(a.tagName.toLowerCase()) &&
                  !w.node.hasClass(a, "fr-marker")))
            )
              ...
              null === o
                ? ((o = w.doc.createElement(n)),
                  ...
                  r.appendChild(o))
                : !1 === i &&
                  (o.appendChild(w.doc.createElement("br")),
                  t &&
                    (o.setAttribute("class", "fr-temp-div"),
                    o.setAttribute("data-empty", !0))),
                (o = null);
      ...
      function n(e) {
        ...
        for (
          ...
          if (!s(n.parentNode, !0)) {
            var r =
                w.node.isBlock(n.parentNode) || w.node.isElement(n.parentNode),
              o = n.textContent
                .replace(/(?!^)( ){2,}(?!$)/g, " ")
                .replace(/\n/g, " ")
                .replace(/^[ ]{2,}/g, " ")
            ...
            if (r) {
              var i = n.previousSibling,
                a = n.nextSibling;
              i && a && " " === o
                ? (o = w.node.isBlock(i) && w.node.isBlock(a) ? "" : " ")
                : (i || (o = o.replace(/^ */, "")),
                  a || (o = o.replace(/ *$/, "")));
            }
            n.textContent = o;
      ...
      function c(e) {
        ...
        if (
          t &&
          (w.node.isBlock(t) || w.node.isElement(t)) &&
          ...
          !t ||
            ...
            e.previousSibling ||
            e.nextSibling ||
            !w.node.isDeletable(e.parentNode) ||
            c(e.parentNode);
      }
      function g() {
        ...
        w.node.isEmpty(w.el) &&
          (null !== d()
            ? w.el.querySelector(p()) ||
              w.el.querySelector(
                "".concat(
                  w.opts.htmlDoNotWrapTags.join(":not(.fr-marker),"),
                  ":not(.fr-marker)"
                )
              ) ||
              (w.core.hasFocus()
                ? (w.$el.html(
                  ...
                  w.selection.restore())
                : w.$el.html("<".concat(d(), "><br/></").concat(d(), ">")))
            : w.el.querySelector("*:not(.fr-marker):not(br)") ||
              (w.core.hasFocus()
                ? (w.$el.html("".concat(V.MARKERS, "<br/>")),
                  w.selection.restore())
                : w.$el.html("<br/>")));
      }
      function C(e, t) {
      ...
      function _() {
        for (
          var e = w.el.querySelectorAll("input, textarea"), t = 0;
          t < e.length;
          t++
        )
      ...
      function h(e) {
        var t = null;
        if (
          (void 0 === e && (t = w.selection.element()),
        ...
        var n,
          ...
          o = t
            ...
            : 0;
        if (
          (w.el.textContent.match(/\u200B/g) || []).length -
            w.el.querySelectorAll(".fr-marker").length ===
          o
        )
          return !1;
        do {
          ...
          for (var i = 0; i < n.length; i++) {
            ...
            if (t !== a) {
              ...
              0 === a.children.length &&
                1 === s.length &&
                8203 === s.charCodeAt(0) &&
                ["TD", "STRONG", "SPAN", "EM", "U", "S", "SUB", "SUP"].indexOf(
                  a.tagName
                ) < 0 &&
                (u(a).remove(), (r = !0));
            }
      ...
      return {
        ...
        get: function B(e, t) {
          ...
          var r,
            ...
            a = {},
            s = [];
          if ((_(), !w.opts.useClasses && !t)) {
            var l = new RegExp(
              "^".concat(w.opts.htmlIgnoreCSSProperties.join("$|^"), "$"),
              "gi"
            );
            for (r = 0; r < w.doc.styleSheets.length; r++) {
              ...
              try {
                (c = w.doc.styleSheets[r].cssRules),
                  w.doc.styleSheets[r].ownerNode &&
                    "STYLE" === w.doc.styleSheets[r].ownerNode.nodeType &&
                    (d = 1);
              } catch (O) {}
              if (c)
                for (var f = 0, p = c.length; f < p; f++)
                  if (c[f].selectorText && 0 < c[f].style.cssText.length) {
                    var h = c[f].selectorText
                    ...
                    for (o = 0; o < u.length; o++) {
                      !u[o].getAttribute("fr-original-style") &&
                      u[o].getAttribute("style")
                        ? (u[o].setAttribute(
                          ...
                          i.push(u[o]))
                        : u[o].getAttribute("fr-original-style") ||
                          (u[o].setAttribute("fr-original-style", ""),
                          i.push(u[o])),
                        a[u[o]] || (a[u[o]] = {});
                      for (
                        var g = 1e3 * d + $(c[f].selectorText),
                          C = c[f].style.cssText.split(";"),
                          m = 0;
                        m < C.length;
                        m++
                      ) {
          ...
          if (w.node.isEmpty(w.el))
            w.opts.fullPage &&
              ...
              (n += "<html"
                .concat(w.node.attributes(w.$html.get(0)), ">")
                .concat(
                  w.$html.find("head").get(0).outerHTML,
                  "<body></body></html>"
                )));
        ...
        getSelected: function T() {
          function e(e, t) {
            for (
              ...
              !(
                (t.nextSibling &&
                  ("BR" === t.nextSibling.nodeName ||
                    w.node.isBlock(t.nextSibling))) ||
                (t.previousSibling &&
                  ("BR" === t.previousSibling.nodeName ||
                    w.node.isBlock(t.previousSibling))) ||
              ...
              t &&
                t.nodeType !== Node.TEXT_NODE &&
                u(e).wrapInner(
                  w.node.openTagString(t) + w.node.closeTagString(t)
                ),
                (t = t.parentNode);
            t && e.innerHTML === t.innerHTML
              ...
              ? (e.innerHTML =
                  w.node.openTagString(t) +
                  t.innerHTML +
                  w.node.closeTagString(t))
              : t &&
                ((t.nextSibling &&
                  ("BR" === t.nextSibling.nodeName ||
                    w.node.isBlock(t.nextSibling))) ||
          ...
          function t(e) {
            ...
            if (w.win.getSelection) {
              if ((t = w.win.getSelection()) && t.rangeCount) {
                if (
                  ((n = t.getRangeAt(0).commonAncestorContainer),
                  ...
                  for (
                    i && o.setAttribute("style", i),
                      o.append(e.textContent),
                      n = n.parentNode;
                    n && n.parentNode && n.parentNode != w.$el.get(0);
            ...
            return null !== n &&
              (0 <= u(n).parents().toArray().indexOf(w.el) || n === w.el)
              ? n
              : null;
          }
          var n = "";
          if ("undefined" != typeof w.win.getSelection) {
            ...
            for (var r = w.selection.ranges(), o = 0; o < r.length; o++) {
              ...
              i.appendChild(r[o].cloneContents()),
                e(i, t(i)),
                0 < u(i).find(".fr-element").length && (i = w.el),
                (n += i.innerHTML);
            }
          } else
            "undefined" != typeof w.doc.selection &&
              "Text" === w.doc.selection.type &&
              (n = w.doc.selection.createRange().htmlText);
          return n;
        },
        insert: function M(e, t, n) {
          ...
          if (
            ...
            0 === e.indexOf('<i class="fa ') &&
              (r = "<span>&nbsp;".concat(r, "</span>")),
            e.indexOf('class="fr-marker"') < 0 &&
              (r = (function a(e) {
                var t = w.doc.createElement("div");
                return (
                  (t.innerHTML = e), w.selection.setAtEnd(t, !0), t.innerHTML
                );
              })(r)),
            w.node.isEmpty(w.el) && !w.opts.keepFormatOnDelete && f(r))
          )
            w.opts.trackChangesEnabled
              ? w.track_changes.pasteInEmptyEdior(r)
              : (w.el.innerHTML = r);
          else {
            (function s() {
            ...
            if (o)
              if (w.opts.trackChangesEnabled) w.track_changes.pasteInEdior(r);
                ...
                w.node.isLastSibling(o) &&
                  u(o).parent().hasClass("fr-deletable") &&
                  u(o).insertAfter(u(o).parent());
                var i = w.node.blockParent(o);
                if (
                  (f(r) || n) &&
                  (w.node.deepestParent(o) || (i && "LI" === i.tagName))
                ) {
                  if (
                    (i &&
                      "LI" === i.tagName &&
                      (r = (function l(e) {
                        ...
                        for (
                          var n = t.querySelectorAll(
                              ":scope > ".concat(w.html.defaultTag())
                            ),
                            r = n.length - 1;
                          0 <= r;
                          r--
                          ...
                          var o = n[r];
                          w.node.isBlock(o.previousSibling) ||
                            (o.previousSibling &&
                              !w.node.isEmpty(o) &&
                              u("<br>").insertAfter(o.previousSibling),
                            (o.outerHTML = o.innerHTML));
                        }
                        return t.innerHTML;
                      })(r)),
        ...
        unwrap: function A() {
          w.$el.find("div.fr-temp-div").each(function () {
            this.previousSibling &&
              ...
              u(this).before("<br>"),
              u(this).attr("data-empty") ||
              !this.nextSibling ||
              (w.node.isBlock(this.nextSibling) &&
                !u(this.nextSibling).hasClass("fr-temp-div"))
        ...
        cleanBRs: function O() {
          for (
            var e = w.el.getElementsByTagName("br"), t = 0;
            t < e.length;
            t++
          )
            c(e[t]);
    ...
    (V.MODULES.keys = function (d) {
      ...
      function u(e) {
        ["INPUT", "BUTTON", "TEXTAREA"].indexOf(e.target && e.target.tagName) <
          ...
          e.stopPropagation(),
          "" !== d.selection.text() ||
          (d.selection.element().hasAttribute("contenteditable") &&
            "false" ===
              d.selection.element().getAttribute("contenteditable")) ||
      ...
      function l() {
        ...
        if (d.opts.height || d.opts.heightMax) {
          ...
          t &&
            ...
            !d.opts.iframe &&
            e > d.$wp.offset().top - d.helpers.scrollTop() + d.$wp.height() - 20
              ? d.$wp.scrollTop(
                  e +
                    d.$wp.scrollTop() -
              ...
              : d.opts.iframe &&
                n > d.$wp.height() &&
                n &&
                d.$wp.scrollTop(n - d.$wp.height() + 80);
        } else
          (e = d.position.getBoundingRect().top),
      ...
      function c(e) {
        ...
        (function o(e) {
          ...
          (function a(e) {
            var t = e;
            -1 < ["STRONG", "U", "EM"].indexOf(e.nodeName) &&
              e.parentNode &&
              (t = e.parentNode);
            for (
              ...
              d.el.addEventListener("compositionstart", function () {
                if (d.selection.isCollapsed()) {
                  ...
                  if (
                    ...
                    n <= t.textContent.length &&
                    0 < n &&
                    8203 === t.textContent.charCodeAt(n - 1)
                  ) {
                    d.selection.save();
                    var r = d.$el.find(".fr-marker");
                    o(r.get(0).previousSibling).before(V.HAIR_SPACE),
                      (r.get(0).previousSibling.textContent = r
                        .get(0)
                        .previousSibling.textContent.replace(/\u200B/gi, "")),
                      d.selection.restore();
                  }
                }
              }),
                d.el.addEventListener("compositionend", function () {
                  if (d.selection.isCollapsed()) {
                    ...
                    if (
                      ...
                      n <= t.textContent.length &&
                      0 < n &&
                      8202 === t.textContent.charCodeAt(0)
                    ) {
                      d.selection.save();
                      var r = d.$el.find(".fr-marker");
                      (r.get(0).previousSibling.textContent = r
    ...
    (V.MODULES.paste = function (A) {
      ...
      function t(e) {
        ...
        if (
          ...
          ).match('content="Microsoft OneNote')
        )
          return !1;
        ...
        if (e && e.clipboardData && e.clipboardData.getData) {
          ...
          if (
            ...
            /text\/html/.test(t) && !A.browser.safari
              ? ((a = e.clipboardData.getData("text/html")),
                A.browser.mozilla &&
                  ("<p></p>" === a ||
                    "" === a ||
                    /<!--StartFragment-->([ ])<!--EndFragment-->/.test(a) ||
                    /<!--StartFragment-->([<p></p>]*)<!--EndFragment-->/.test(
                      a
                    )) &&
          ...
          (function i() {
            if ((A.selection.save(), A.events.disableBlur(), (a = null), l)) {
              ...
              A.browser.webkit || A.browser.mozilla
                ? ("none" === n && l.css("top", A.$sc.scrollTop()),
                  A.$el.after(l))
                : A.browser.edge && A.opts.iframe
                ? A.$el.append(l)
                : A.$box.after(l),
      ...
      function o(e) {
        ...
        if (e && e.dataTransfer && e.dataTransfer.getData) {
          var t = "";
          if (((O = e.dataTransfer.types), A.helpers.isArray(O)))
            for (var n = 0; n < O.length; n++) t += "".concat(O[n], ";");
          else t = O;
          if (
            ((a = ""),
      ...
      function f() {
        ...
        (!e || (e && !1 !== A.events.trigger("paste.wordPaste", [a]))) &&
          i(a, e);
      }
      function $(e) {
        for (var t = "", n = 0; n++ < e; ) t += "&nbsp;";
      ...
      function i(e, t, n) {
        ...
        0 <= e.indexOf('id="docs-internal-guid') &&
          ...
          (0 <= e.indexOf('content="Sheets"') ||
            0 <= e.indexOf("google-sheets-html-origin")) &&
        ...
        if (!t)
          if (
            ...
            e = A.clean.html(
              e,
              A.opts.pasteDeniedTags,
              A.opts.pasteDeniedAttrs
            );
          else {
            ...
            (A.opts.htmlAllowedStyleProps = A.opts.pasteAllowedStyleProps),
              ...
              (A.html.defaultTag() && "div" === A.html.defaultTag()) ||
                (e = H(e)),
              (e = (e = e.replace(/\r/g, ""))
                .replace(/^ */g, "")
                .replace(/ *$/g, ""));
        ...
        if (
          (A.$el[0].removeAttribute("plainpaste", !0),
          "string" == typeof d && (e = d),
          "" !== e)
        ) {
          var f = A.o_doc.createElement("div");
          0 <= (f.innerHTML = e).indexOf("<body>")
            ? (A.html.cleanBlankSpaces(f), A.spaces.normalize(f, !0))
            : A.spaces.normalize(f);
              ...
              (e = (function T(e) {
                ...
                var r = n.querySelectorAll(
                  "*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not("
                    ...
                    .concat(A.opts.htmlAllowedEmptyTags.join("):not("), ")")
                );
                for (; r.length; ) {
                  for (t = 0; t < r.length; t++)
      ...
      function H(e) {
        ...
        for (
          ...
          if (A.html.defaultTag() && "div" !== A.html.defaultTag())
            o.querySelector(A.html.blockTagsQuery())
              ? (o.outerHTML = o.innerHTML)
              : (o.outerHTML = "<"
                  .concat(A.html.defaultTag(), ">")
                  .concat(o.innerHTML, "</")
          ...
          if (n.undo_stack && !n.undoing && !n.el.querySelector(".fr-marker"))
            if (void 0 === e) {
              if (
                (e = n.snapshot.get()) &&
                e.html &&
                n.undo_stack[n.undo_stack.length - 1] &&
                e.html === n.undo_stack[n.undo_stack.length - 1].html
              )
                return;
    ...
    (V.MODULES.size = function (r) {
      function e() {
        o(),
          r.opts.height &&
            r.$el.css(
              "minHeight",
              r.opts.height -
                r.helpers.getPX(r.$el.css("padding-top")) -
                r.helpers.getPX(r.$el.css("padding-bottom"))
            );
        var e = !1;
        if (r.opts.fullPage)
        ...
        r.opts.fullPage &&
          e &&
          (r.opts.heightMin && r.$iframe.css("minHeight", r.opts.heightMin),
      ...
      function o() {
        r.opts.heightMin
          ? r.$el.css("minHeight", r.opts.heightMin)
          : r.$el.css("minHeight", ""),
          r.opts.heightMax
            ? (r.$wp.css("maxHeight", r.opts.heightMax),
              r.$wp.css("overflow", "auto"))
            : (r.$wp.css("maxHeight", ""), r.$wp.css("overflow", "")),
          r.opts.height
            ? (r.$wp.css("height", r.opts.height),
              r.$wp.css("overflow", "auto"),
              r.$el.css(
                "minHeight",
                r.opts.height -
        ...
        if (
          ...
          (function o() {
            a.opts.iframe || a.$el.addClass("fr-element fr-view"),
              ((a.opts.height && a.opts.height < window.innerHeight) ||
                (a.opts.heightMax && a.opts.heightMax < window.innerHeight)) &&
                a.$el.addClass("fr-element-scroll-visible");
          })(),
          a.opts.iframe)
        ) {
    ...
    (V.MODULES.popups = function (h) {
      ...
      function m(e) {
        return (
          (g[e] &&
            h.node.hasClass(g[e], "fr-active") &&
            h.core.sameInstance(g[e])) ||
          !1
        );
      }
      function v(e) {
      ...
      function n(e) {
        ...
        if (
          ...
          "filesManager.insert" === e &&
            h.filesManager !== undefined &&
            h.filesManager.isChildWindowOpen())
        )
          return !1;
        if (
          t &&
          ...
          h.$tb &&
            (1 < h.opts.zIndex
              ? h.$tb.css("zIndex", h.opts.zIndex + 1)
              : h.$tb.css("zIndex", "")),
      ...
      function c(e, t) {
        var n,
          r = (function c(e, t) {
            ...
            if (!n) return null;
            for (var r in ("function" == typeof n && (n = n.apply(h)), t))
              Object.prototype.hasOwnProperty.call(t, r) &&
        ...
        "filesManager.insert" === e
          ? o.addClass(
              "fr-popup fr-files-manager"
                .concat(h.helpers.isMobile() ? " fr-mobile" : " fr-desktop")
                .concat(h.opts.toolbarInline ? " fr-inline" : "")
            )
          : o.addClass(
              "fr-popup"
                .concat(h.helpers.isMobile() ? " fr-mobile" : " fr-desktop")
          ...
          1 < h.opts.zIndex &&
            (!h.opts.editInPopup && h.$tb
              ? h.$tb.css("z-index", h.opts.zIndex + 2)
              : o.css("z-index", h.opts.zIndex + 2)),
          "auto" !== h.opts.direction &&
            o
              .removeClass("fr-ltr fr-rtl")
              .addClass("fr-".concat(h.opts.direction)),
          o
            .find("input, textarea")
            .attr("dir", h.opts.direction)
        ...
        return {
          _windowResize: function () {
            ...
            if (!e.helpers.isMobile() && s.isVisible()) {
              ...
              if (
                ...
                e.events.disableBlur(), e.popups.hide(a), e.events.enableBlur();
            }
          },
          ...
          _editorKeydown: function (e) {
            ...
            t.keys.ctrlKey(e) ||
              ...
              (m(a) && s.findVisible(".fr-back").length
                ? t.button.exec(s.findVisible(".fr-back").first())
                : e.which !== V.KEYCODE.ALT && t.popups.hide(a));
          },
          _preventFocus: function (e) {
            ...
            "mouseup" === e.type || d(n).is(":focus") || t.events.disableBlur(),
              "mouseup" !== e.type ||
                ...
                h.button.hideActiveDropdowns(s),
              (h.browser.safari || h.browser.mozilla) &&
                "mousedown" === e.type &&
          ...
          _windowMouseup: function (e) {
            ...
            s.isVisible() &&
              l() &&
              (e.stopPropagation(), t.markers.remove(), t.popups.hide(a), L());
          },
          ...
          handleWindowClick: function (e) {
            ...
            s.isVisible() &&
              e.target &&
              (0 < d(e.target).find("body").length ||
                "BODY" === d(e.target)[0].tagName) &&
              (e.stopPropagation(), t.popups.hide(a));
          },
        };
      }
      function f(e, t) {
        h.events.on("mouseup", e._editorMouseup, !0),
          ...
          h.$wp &&
            !h.helpers.isMobile() &&
            h.events.$on(h.$wp, "scroll.popup".concat(t), e._repositionPopup),
          h.events.on("window.mouseup", e._windowMouseup, !0),
          h.events.on("window.keydown", e._windowKeydown, !0),
          h.opts.iframe &&
            window.addEventListener("click", e.handleWindowClick),
          g[t].data("inst".concat(h.id), !0),
          h.events.on(
            "destroy",
            function () {
              h.core.sameInstance(g[t]) &&
      ...
      return (
        (h.shared.exit_flag = !1),
        {
          ...
          show: function T(e, t, n, r, o) {
            if (
              (m(e) ||
                (v() && 0 < h.$el.find(".fr-marker").length
                  ? (h.events.disableBlur(), h.selection.restore())
                  : v() ||
                    (h.events.disableBlur(),
                    h.events.focus(),
                    h.events.enableBlur())),
            ...
            if (
              ...
              h.opts.toolbarInline &&
                ...
                (n =
                  h.$tb.offset().top -
                  h.helpers.getPX(h.$tb.css("margin-top"))),
                (t = h.$tb.offset().left + h.$tb.outerWidth() / 2),
                h.node.hasClass(h.$tb.get(0), "fr-above") &&
                  n &&
                  (n += h.$tb.outerHeight()),
                (r = 0)),
            ...
            s.is(h.$tb)
              ? h.$tb.css("zIndex", (h.opts.zIndex || 1) + 4)
              : g[e].css("zIndex", (h.opts.zIndex || 1) + 3),
              h.opts.toolbarBottom &&
                s &&
                h.$tb &&
                s.get(0) === h.$tb.get(0) &&
                (g[e].addClass("fr-above"), n && (n -= g[e].outerHeight())),
              o && (t -= g[e].width() / 2),
              t + g[e].outerWidth() > h.$sc.offset().left + h.$sc.width() &&
                (t -=
                  t + g[e].outerWidth() - h.$sc.offset().left - h.$sc.width()),
              t < h.$sc.offset().left &&
                "rtl" === h.opts.direction &&
                (t = h.$sc.offset().left),
    ...
    (V.MODULES.accessibility = function (f) {
      ...
      function l(t) {
        ...
        if (t && t.length && !n) {
          ...
          f.browser.safari &&
            (f.shared.safariSelection = f.selection
              .get()
              .getRangeAt(0)
              .cloneRange()),
      ...
      function e(e) {
        ...
        var n = f.popups.areVisible(f),
          r = !1;
        return (
          n && (r = u(n.children().not(".fr-buttons"))),
          r || c(),
          (f.shared.with_kb = !1),
          e.preventDefault(),
          e.stopPropagation(),
        ...
        if (!p.helpers.isMobile()) {
          ...
          if ("trackChanges" === n)
            ...
            ("applyAll" === n ||
              ...
              "applyLast" === n ||
              "removeLast" === n) &&
            0 === p.track_changes.getPendingChanges().length
          )
            return;
          if ((e.data("title", r), e.data("title"))) {
              ...
              (function f() {
                if (p.opts.tooltips && !p.helpers.isMobile()) {
                  if (p.shared.$tooltip) p.$tooltip = p.shared.$tooltip;
                    ...
                    (p.shared.$tooltip = h(p.doc.createElement("DIV")).addClass(
                      "fr-tooltip"
                    )),
                      (p.$tooltip = p.shared.$tooltip),
                      p.opts.theme &&
                        p.$tooltip.addClass("".concat(p.opts.theme, "-theme"));
                    var e = p.$wp.closest("dialog");
                    0 < e.length
                      ? e.first().append(p.$tooltip)
                      : h(p.o_doc).find("body").first().append(p.$tooltip);
                  }
                  p.events.on(
                    "shared.destroy",
                    function () {
            ...
            var l =
              e.offset().left + (e.outerWidth() - p.$tooltip.outerWidth()) / 2;
            l < 0 && (l = 0),
              l + p.$tooltip.outerWidth() > h(p.o_win).width() &&
                (l = h(p.o_win).width() - p.$tooltip.outerWidth()),
              void 0 === t && (t = p.opts.toolbarBottom),
              e.offset().top - h(window).scrollTop() + e.outerHeight() + 10 >=
                h(window).height() && (t = !0);
            var c = t
              ? e.offset().top - p.$tooltip.height()
            ...
            0 < d.length
              ? (p.$tooltip.css("margin-left", -d.first().offset().left),
                p.$tooltip.css("margin-top", -d.first().offset().top))
              : "static" !== h(p.o_doc).find("body").first().css("position")
              ? (p.$tooltip.css(
                  "margin-left",
                  -h(p.o_doc).find("body").first().offset().left
                ),
                p.$tooltip.css(
                  "margin-top",
                  -h(p.o_doc).find("body").first().offset().top
                ))
              : (p.$tooltip.css("margin-left", ""),
        ...
        bind: function i(e, t, n) {
          p.opts.tooltips &&
            ...
            (p.events.$on(
              ...
              t,
              function (e) {
                p.node.hasClass(e.currentTarget, "fr-disabled") ||
                  p.edit.isDisabled() ||
                  o(h(e.currentTarget), n);
              },
              !0
            ),
            p.events.$on(
    ...
    (V.MODULES.button = function (g) {
      ...
      function i(e) {
        ...
        if (!n) {
          ...
          if (
            ...
            t.offset().top + e.outerHeight() + i < u(g.o_doc).height()
          )
      ...
      function t(e) {
        ...
        if (
          (0 === e.parents(".fr-popup").length &&
            ...
            ((e.attr("id") === "insertLink-".concat(g.id) &&
              n &&
          ...
          for (var r = 0; r < V.INSTANCES.length; r++)
            V.INSTANCES[r] !== t &&
              V.INSTANCES[r].popups &&
              V.INSTANCES[r].popups.areVisible() &&
              V.INSTANCES[r].$el.find(".fr-marker").remove();
          t.popups.hideAll();
        }
      ...
      return {
        ...
        bindCommands: function y(t, e) {
          ...
          function o(e) {
            (!e ||
              (e.type === g._mouseup && e.target !== u("html").get(0)) ||
              ("keydown" === e.type &&
                ...
                (function r(e) {
                  ...
                  if (t.length) {
                    t
                      ...
                      .css("height", ""),
                      t
                        .parents(".fr-toolbar:not(.fr-inline)")
                        .css("zIndex", ""),
                      t.prev().removeClass("fr-expanded");
          ...
          g.events.$on(u(r), "".concat(g._mouseup, " resize keydown"), o, !0),
            ...
            g.node.hasClass(t.get(0), "fr-popup")
              ? u.merge(s, t.find(".fr-btn").toArray())
              : u.merge(a, t.find(".fr-btn").toArray()),
    ...
    (V.MODULES.position = function (L) {
      ...
      function o() {
        ...
        if ((0 === t.top && 0 === t.left && 0 === t.width) || 0 === t.height) {
          var n = !1,
            r =
              L.opts.toolbarInline &&
              e.startContainer &&
              e.startContainer.firstChild &&
              "BR" === e.startContainer.firstChild.tagName;
          0 === L.$el.find(".fr-marker").length &&
            (r
              ? E(e.startContainer.firstChild).after(V.MARKERS)
              : L.selection.save(),
            (n = !0));
          ...
          o.css("display", "none"),
            ...
            (t.ok = !0),
            n &&
              (r ? L.$el.find(".fr-marker").remove() : L.selection.restore());
        }
        return t;
      }
      function i(e, t, n, r) {
      ...
      function t(e) {
        if (e.offsetWidth) {
          ...
          if (g || C) {
            ...
            t.css(
              "width",
              "".concat(c.get(0).getBoundingClientRect().width - m, "px")
            ),
              l ||
      ...
      function s() {
        if (
          (L.helpers.requestAnimationFrame()(s),
      ...
      return {
                      ...
                      if (L.core.hasFocus())
                        for (var e = 0; e < L._stickyElements.length; e++) {
                          ...
                          t.outerHeight() < r - n.offset().top &&
                            ((L.opts.toolbarBottom && L.helpers.isIOS()) ||
        ...
        addSticky: function c(e) {
          e.addClass("fr-sticky"),
            L.helpers.isIOS() &&
              !L.opts.toolbarBottom &&
              e.addClass("fr-sticky-ios"),
          ...
          for (var t = l.selection.blocks(), n = 0; n < t.length; n++) {
            ...
            if (
              [
                ...
                "BLOCKQUOTE",
                "BODY",
              ].indexOf(o.parentNode.tagName) < 0
            )
              return i(e, !0), !0;
            if (
              t[0].previousSibling &&
    ...
    (V.TOOLBAR_BUTTONS_SM.trackChanges = Object.assign(
      {},
      V.TOOLBAR_BUTTONS.trackChanges,
      { buttonsVisible: 0 }
    )),
    ...
    (V.TOOLBAR_BUTTONS_XS.trackChanges = Object.assign(
      {},
      V.TOOLBAR_BUTTONS.trackChanges,
      { buttonsVisible: 0 }
    )),
    ...
    (V.MODULES.toolbar = function (E) {
      ...
      function T() {
          ...
          c.hasClass("fr-expanded")
            ? (function () {
                ...
                if (
                  ...
                  (n += s * (n / c[0].childElementCount)),
                    (s = Math.ceil(n / E.$tb.outerWidth()));
        ...
        !E.helpers.isMobile() && E.opts.toolbarBottom
          ? E.$tb
              .find(".fr-toolbar .fr-more-toolbar")
      ...
      function o() {
        if (
          0 ==
            E.$tb.find("[data-name='trackChanges-".concat(E.id, "']")).length &&
          -1 < E.opts.pluginsEnabled.indexOf("track_changes")
        ) {
          E.$tb.append(
            S('<div class="fr-more-toolbar"></div>').data(
              "name",
              "trackChanges-".concat(E.id)
            )
          );
          for (
            var e = 0,
            ...
            if (r) {
              ...
              E.button.addButtons(o),
                E.$tb
                  .find("[data-name='trackChanges-".concat(E.id, "']"))
                  .append(o);
            }
          }
        }
            ...
            if (
              ...
              "trackChanges" !== l &&
                (h = S(
                  '<div class="fr-btn-grp fr-float-'.concat(
                    i[l].align ? i[l].align : "left",
                    '"></div>'
                  )
                )),
                i.showMoreButtons &&
                  ((d = S('<div class="fr-more-toolbar"></div>').data(
                    "name",
                    "".concat(l, "-").concat(E.id)
                  )),
                  ("trackChanges" !== l && "moreRich" !== l) ||
                    !E.opts.trackChangesEnabled ||
                    d.addClass("fr-expanded"));
              for (var u = 0; u < c.buttons.length; u++) {
                ...
                var g = E.$tb.find(
                  ...
                  C = null;
                E.node.hasClass(g.next().get(0), "fr-dropdown-menu") &&
                  (C = g.next()),
                  E.node.hasClass(g.next().get(0), "fr-options") &&
                    (g.removeClass("fr-hidden"),
                    g.next().removeClass("fr-hidden"),
                    (g = g.parent())),
                  g.removeClass("fr-hidden"),
                  i.showMoreButtons && p <= f
                    ? (d.append(g), C && d.append(C))
                    : (h.append(g), C && h.append(C)),
                  f++;
              }
      ...
      function n(e, t) {
        setTimeout(function () {
          if (
            ...
            !E.popups.areVisible() &&
            "false" !=
              S(E.selection.blocks()[0])
                .closest("table")
                .attr("contenteditable") &&
            (E.opts.toolbarVisibleWithoutSelection ||
              (!E.selection.isCollapsed() && !E.keys.isIME()) ||
              t)
          ) {
            if (
              (E.$tb.data("instance", E),
              !1 === E.events.trigger("toolbar.show", [e]))
            )
              return;
            E.$tb.show(),
              E.opts.toolbarContainer || E.position.forSelection(E.$tb),
              1 < E.opts.zIndex
                ? E.$tb.css("z-index", E.opts.zIndex + 1)
                : E.$tb.css("z-index", null);
          }
        }, 0);
      }
      function i(e) {
        return (
          ...
          (!(!e || "keydown" !== e.type || !E.keys.ctrlKey(e)) ||
            !!E.button
              ...
              .next()
              .find(E.o_doc.activeElement).length ||
            (E.helpers.isMobile() &&
              E.opts.toolbarInline &&
              (E.$tb.find(".fr-expanded").toggleClass("fr-expanded"),
      ...
      (t[V.XS] = e(
        E.opts.toolbarButtonsXS ||
          E.opts.toolbarButtons ||
          V.TOOLBAR_BUTTONS_XS ||
          V.TOOLBAR_BUTTONS ||
          []
      )),
        (t[V.SM] = e(
          E.opts.toolbarButtonsSM ||
            E.opts.toolbarButtons ||
      ...
      function a(e) {
        clearTimeout(r),
          (e && e.which === V.KEYCODE.ESC) ||
            (r = setTimeout(n, E.opts.typingTimer));
      }
      function s() {
        E.events.on("window.mousedown", i),
          ...
          E.helpers.isMobile()
            ? E.helpers.isIOS() ||
              (E.events.on("window.touchend", n),
              E.browser.mozilla && setInterval(n, 200))
            : E.events.on("window.keyup", a),
          ...
          E.helpers.isMobile() &&
            (E.events.$on(E.$doc, "selectionchange", a),
      ...
      function l() {
        E.$tb.html("").removeData().remove(),
          (E.$tb = null),
          E.$second_tb &&
            (E.$second_tb.html("").removeData().remove(),
            (E.$second_tb = null));
      }
      function c() {
      ...
      function d() {
        E.opts.theme && E.$tb.addClass("".concat(E.opts.theme, "-theme")),
          ...
          "auto" !== E.opts.direction &&
            E.$tb
              .removeClass("fr-ltr fr-rtl")
              .addClass("fr-".concat(E.opts.direction)),
          E.helpers.isMobile()
            ? E.$tb.addClass("fr-mobile")
            : E.$tb.addClass("fr-desktop"),
          E.opts.toolbarContainer
            ? (E.opts.toolbarInline && (s(), i()),
              E.opts.toolbarBottom
            ...
            : (function e() {
                E.opts.toolbarInline
                  ? (E.$sc.append(E.$tb),
                    ...
                    s(),
                    (E.opts.toolbarBottom = !1))
                  : (E.opts.toolbarBottom
                      ? (E.$box.append(E.$tb),
                        E.$tb.addClass("fr-bottom"),
                        E.$box.addClass("fr-bottom"))
                      : ((E.opts.toolbarBottom = !1),
                        E.$box.prepend(E.$tb),
                        E.$tb.addClass("fr-top"),
                    ...
                    E.opts.toolbarSticky &&
                      (E.opts.toolbarStickyOffset &&
                        (E.opts.toolbarBottom
                          ? E.$tb.css("bottom", E.opts.toolbarStickyOffset)
                          : E.$tb.css("top", E.opts.toolbarStickyOffset)),
          ...
          (function r() {
            E.events.$on(S(E.o_win), "resize", o),
              ...
              E.opts.toolbarButtons &&
                -1 <
                  JSON.stringify(E.opts.toolbarButtons).indexOf(
                    "trackChanges"
                  ) &&
                o();
            var e = E.$tb.find(
                ".fr-more-toolbar[data-name=trackChanges-".concat(E.id, "]")
              ),
          ...
          E.helpers.isMobile() &&
            E.events.$on(E.$tb, "click", function () {
              E.popups.areVisible().length ||
                (E.id !== E.shared.selected_editor &&
                  E.shared.selected_editor) ||
                E.$el.focus();
            }),
          E.events.$on(E.$tb, "transitionend", ".fr-more-toolbar", function () {
            E.$box.hasClass("fr-fullscreen") &&
              ((E.opts.height =
                E.o_win.innerHeight -
                (E.opts.toolbarInline
                  ? 0
                  : E.$tb.outerHeight() +
                    (E.$second_tb ? E.$second_tb.outerHeight() : 0))),
              E.size.refresh());
          });
      }
      var f = !1;
      return {
        _init: function p() {
          ...
          E.opts.toolbarInline ||
            E.opts.toolbarBottom ||
            ((E.$second_tb = S(E.doc.createElement("div")).attr(
              "class",
              "fr-second-toolbar"
            )),
            E.$box.append(E.$second_tb),
            (!1 !== E.ul || E.opts.attribution) &&
              E.$second_tb.prepend(V.POWERED_BY)),
            E.opts.toolbarContainer
              ? (E.shared.$tb
                  ? ((E.$tb = E.shared.$tb), E.opts.toolbarInline && s())
                  : ((E.shared.$tb = S(E.doc.createElement("DIV"))),
                    ...
                    E.$tb.data("instance", E)),
                E.opts.toolbarInline
                  ? E.$box.addClass("fr-inline")
                  : E.$box.addClass("fr-basic"),
                E.events.on(
                  "focus",
                  function () {
                    E.$tb.data("instance", E);
            ...
            E.events.on(
              E.opts.toolbarInline || E.opts.toolbarContainer
                ? "shared.destroy"
                : "destroy",
              l,
              !0
            ...
            (function e() {
              E.events.on("shortcut", function (e, t, n) {
                ...
                if (
                  (t && !n
                    ? (r = E.$tb.find('.fr-command[data-cmd="'.concat(t, '"]')))
                    : t &&
                      n &&
                      (r = E.$tb.find(
                        '.fr-command[data-cmd="'
    ...
    //   },
      ...
      css: function (e, t) {
        ...
        if ("string" == typeof e) {
          ...
          return (
            (e = m(this).getCorrectStyleName(e)), o.getComputedStyle(this[0])[e]
          );
        }
        for (var i in e)
        ...
        for (t = " " + e + " "; (n = this[r++]); )
          if (
            ...
            -1 <
              (
                " " +
                m(this).stripAndCollapse(m(this).getClass(n)) +
                " "
              ).indexOf(t)
          )
            return !0;
      ...
      off: function (e) {
        ...
        for (var r = 0; r < this.length; r++) {
          ...
          if (o.data("events")) {
            ...
            i = i[0];
            for (
              var a = o.data("events") || [], s = a.length - 1;
              0 <= s;
              s--
            ) {
              var l = a[s];
      ...
      find: function (e) {
        ...
        var o = function o(e) {
          return "object" ===
            ("undefined" == typeof HTMLElement ? "undefined" : M(HTMLElement))
      ...
      prev: function () {
        return this.length && this[0].previousElementSibling
          ? m(this[0].previousElementSibling)
          : m();
      },
      next: function () {
      ...
      outerHeight: function (e) {
        ...
        if (
          (e &&
            (i +=
              parseInt(m(t).css("marginTop")) +
              parseInt(m(t).css("marginBottom"))),
          !r)
        )
      ...
      outerWidth: function (e) {
        ...
        if (
          (e &&
            (i +=
              parseInt(m(t).css("marginLeft")) +
              parseInt(m(t).css("marginRight"))),
          !r)
        )
          for (var a in s) t.style[a] = n[a];
        return i;
      ...
      parentsUntil: function (e, t) {
        ...
        for (var r = 0; r < this.length; r++)
          for (
            ...
            o != e &&
            this[r] != e &&
            ("string" != typeof e || !Element.prototype.matches.call(o, e));
      ...
      this.opts.initOnClick
        ? (this.load(b.MODULES),
          ...
          this.$el.on(
            ...
            function r(e) {
              if (
                "false" !== this.$el.attr("contentEditable") ||
                !this.opts.initOnClick
              ) {
                ...
                if (1 === e.which || !e.which) {
                  ...
                  if (
                    ...
                    "touchend" === e.type &&
                      ...
                      u(e.originalEvent.target).is("img"))
                  ) {
                    var n = this;
                    setTimeout(function () {
    ...
    (b.Bootstrap = function (e, t, n) {
      ...
      "function" == typeof t && ((n = t), (t = {})),
        ...
        (this.opts = Object.assign(
          {},
          Object.assign({}, b.DEFAULTS, r, "object" === M(t) && t)
        ));
      ...
      var t = function () {
          "TEXTAREA" !== e &&
            ...
            this.opts.iframe
              ...
              : ((this.$el = u(this.o_doc.createElement("DIV"))),
                (this.el = this.$el.get(0)),
                (this.$wp = u(this.o_doc.createElement("DIV")).append(
                  this.$el
                )),
                this.$box.html(this.$wp)),
